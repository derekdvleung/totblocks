...
- [`dual/`](dual/) 					3D models used for the dual-colour version of TotBlocks (single chain, *w* = 1). 
  ...
  - [`oblock-m2-plus-dual-0.stl`](dual/oblock-m2-plus-dual-0.stl)			*O<sup>+</sup>* module, part 1.
  - [`oblock-m2-plus-dual-1.stl`](dual/oblock-m2-plus-dual-1.stl)			*O<sup>+</sup>* module, part 2.
  - [`tblock-n1-minus-dual-0.stl`](dual/oblock-n1-minus-dual-0.stl)			*T<sup>−</sup>* module, part 1.[^1]
  - [`tblock-n1-minus-dual-1.stl`](dual/oblock-n1-minus-dual-1.stl)			*T<sup>−</sup>* module, part 2.[^1]
  - [`tblock-n1-plus-dual-0.stl`](dual/oblock-m2-plus-dual-0.stl)			*T<sup>+</sup>* module, part 1.[^1]
  - [`tblock-n1-plus-dual-1.stl`](dual/oblock-m2-plus-dual-1.stl)			*T<sup>+</sup>* module, part 2.[^1]
		
- [`oblock/`](oblock/)				*O* modules (`m` = *Z* from Nespolo and Bouznari, 2017)
  - [`oblock-m11-minus.stl`](oblock/oblock-m11-minus.stl)					Quadruple chain (*w* = 4) *O<sup>−</sup>* module.
  - [`oblock-m11-plus.stl`](oblock/oblock-m11-plus.stl)						Quadruple chain (*w* = 4) *O<sup>+</sup>* module.
  - [`oblock-m2-minus.stl`](oblock/oblock-m2-minus.stl)						Single chain (*w* = 1) *O<sup>−</sup>* module.
  - [`oblock-m2-plus.stl`](oblock/oblock-m2-plus.stl)						Single chain (*w* = 1) *O<sup>+</sup>* module.
  - [`oblock-m3-plus.stl`](oblock/oblock-m3-plus.stl)						*Z*<sub>3</sub> *O<sup>+</sup>* module for kalifersite.
  - [`oblock-m5-minus.stl`](oblock/oblock-m5-minus.stl)						Double chain (*w* = 2) *O<sup>−</sup>* module.
  - [`oblock-m5-plus.stl`](oblock/oblock-m5-plus.stl)						Double chain (*w* = 2) *O<sup>+</sup>* module.
  - [`oblock-m6-plus.stl`](oblock/oblock-m6-plus.stl)						*Z*<sub>6</sub> *O<sup>+</sup>* module for kalifersite.
  - [`oblock-m8-minus.stl`](oblock/oblock-m8-minus.stl)						Triple chain (*w* = 3) *O<sup>−</sup>* module.
  - [`oblock-m8-plus.stl`](oblock/oblock-m8-plus.stl)						Triple chain (*w* = 3) *O<sup>+</sup>* module.
  - [`oblock-support-enforcer.stl`](oblock/oblock-support-enforcer.stl)		Support enforcer for the *O* modules. When slicing (in Prusaslicer), right click on the *O* module, then "add support enforcer". 
  ...
  - [`single-octahedron-clips.stl`](oblock/single-octahedron-clips.stl)		An octahedron that fits between *O* modules that are joined by phyllosilicate-type linkages to fill in the missing sites.
  - [`single-octahedron.stl`](oblock/single-octahedron.stl)					An octahedron that fits between *O* modules that are joined by phyllosilicate-type linkages to fill in the missing sites.
...
- [`quartz`](quartz/)														Experimental modules for quartz. These modules do not have pags and thus have to be glued together to extend the structure.
  - [`quartz-module.stl`](quartz/quartz-module.stl)							3<sub>2</sub> screw axis module for quartz (two repeats).

- [`tblock`](tblock/)				T modules (`n` = *w* from Leung and dePolo, 202x)
  - [`tblock-n1-minus.stl`](tblock/tblock-n1-minus.stl)						Single chain (*w* = 1) *T<sup>−</sup>* module.[^1]
  - [`tblock-n1-plus.stl`](tblock/tblock-n1-plus.stl)						Single chain (*w* = 1) *T<sup>+</sup>* module.[^1]
  - [`tblock-n2-minus.stl`](tblock/tblock-n2-minus.stl)						Double chain (*w* = 2) *T<sup>−</sup>* module.[^1]
  - [`tblock-n2-plus.stl`](tblock/tblock-n2-plus.stl)						Double chain (*w* = 2) *T<sup>+</sup>* module.[^1]
  - [`tblock-n3-minus.stl`](tblock/tblock-n3-minus.stl)						Triple chain (*w* = 3) *T<sup>−</sup>* module.[^1]
  - [`tblock-n3-plus.stl`](tblock/tblock-n3-plus.stl)						Triple chain (*w* = 3) *T<sup>+</sup>* module.[^1]
  - [`tblock-n4-minus.stl`](tblock/tblock-n4-minus.stl)						Quadruple chain (*w* = 4) *T<sup>−</sup>* module.[^1] 
  - [`tblock-n4-plus.stl`](tblock/tblock-n4-plus.stl)						Quadruple chain (*w* = 4) *T<sup>+</sup>* module.[^1]
